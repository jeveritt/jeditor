...
/** -isenc : Specifies that the file is encrypted */
  static final String ARG_FILE_IS_ENCRYPTED          = "-isenc";
...
/** -enro : Specifies that the file is encrypted and read only*/
  static final String ARG_ALLOW_ENCRYPTED_READ_ONLY  = "-enro";
/** -enrw : Specifies that the file is encrypted and read/write */
  static final String ARG_ALLOW_ENCRYPTED_READ_WRITE = "-enrw";
